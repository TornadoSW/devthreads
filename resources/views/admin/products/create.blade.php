...
@section('content')
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold mt-3">
            ...
            @else
                Add New <span class="gradient-text">Product</span>
            @endif
        </h1>
    </div>
    ...
    <form action="{{ isset($product) ? route('admin.products.update', $product) : route('admin.products.store') }}"
        ...
        <div class="glass rounded-2xl p-6 space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" required
                       ...
                       placeholder="e.g. git push --force Friday Tee"
        ...
        <div class="glass rounded-2xl p-6 space-y-5">
            ...
            <div>
                ...
                <p class="text-xs text-gray-600 mt-2">PNG, JPG, or WebP. Max 2MB. Recommended: 800x800px square.</p>
